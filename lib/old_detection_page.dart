...
class DetectionPage extends StatefulWidget {
  ...
  const DetectionPage({required this.cameras, required this.objectModels, required this.selectedModel, required this.robotName, required this.url, required this.authKey, required this.teamName, Key? key}) : super(key: key);
